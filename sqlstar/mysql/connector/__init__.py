...
from .errors import (  # pylint: disable=W0622
    ...
    InternalError, custom_error_exception, PoolError)
from .constants import FieldFlag, FieldType, CharacterSet, \
    RefreshOption, ClientFlag
from .dbapi import (Date, Time, Timestamp, Binary, DateFromTicks,
                    TimestampFromTicks, TimeFromTicks, STRING, BINARY, NUMBER,
                    DATETIME, ROWID, apilevel, threadsafety, paramstyle)
from .optionfiles import read_option_files

if PY2:
    warnings.warn(
        "MySQL Connector/Python will drop support for Python 2.7 in "
        "release 8.0.24. Please upgrade your Python as Python 2.7 "
        "won't work after this release",
...
def _get_pooled_connection(**kwargs):
    ...
    from .pooling import (MySQLConnectionPool, generate_pool_name,
